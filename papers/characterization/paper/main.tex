...
coupling characterization, response curve, uncertainty quantification, system
...
\paragraph{Doctrine.}
The sweep is calibration in the metrological sense --- the walk is
measured against reference truths, as an instrument is calibrated
against certified standards --- and it is not pass/fail. No minimum performance bar is
