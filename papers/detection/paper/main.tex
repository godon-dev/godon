...
invisible to each agent individually. We present a method by which
such agents discover their coupling structure through a coordinated
push/pause/hold protocol: one agent deliberately drives its parameters
